...
public class MailTemplate {
    private static String mailContent = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><!--[if IE]><html xmlns=\"http://www.w3.org/1999/xhtml\" class=\"ie\"><![endif]--><!--[if !IE]><!--><html style=\"margin: 0;padding: 0;\" xmlns=\"http://www.w3.org/1999/xhtml\"><!--<![endif]--><head>\n" +
...
"body{background-color:#e6dbda}.logo a:hover,.logo a:focus{color:#859bb1 !important}.mso .layout-has-border{border-top:1px solid #bda09d;border-bottom:1px solid #bda09d}.mso .layout-has-bottom-border{border-bottom:1px solid #bda09d}.mso .border,.ie .border{background-color:#bda09d}.mso h1,.ie h1{}.mso h1,.ie h1{font-size:36px !important;line-height:43px !important}.mso h2,.ie h2{}.mso h2,.ie h2{font-size:22px !important;line-height:31px !important}.mso h3,.ie h3{}.mso h3,.ie h3{font-size:18px !important;line-height:26px !important}.mso .layout__inner,.ie .layout__inner{}.mso .footer__share-button p{}.mso .footer__share-button p{font-family:Ubuntu,sans-serif}\n" +
...
"<!--<![endif]-->\n" +
"    <table class=\"wrapper\" style=\"border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #e6dbda;\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\"><tbody><tr><td>\n" +
"      <div role=\"banner\">\n" +
...
"        <h1 style=\"Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;\"><strong>Votre commande a &#233;t&#233; mise en attente</strong></h1><p style=\"Margin-top: 20px;Margin-bottom: 0;\">&nbsp;<br />\n" +
"Hi there, Global Expertise et l'&#233;quipe vous informe que votre commande a &#233;t&#233; mise en attente d&#251; au manque de produits dans nos stocks. Nous faisons tout pour r&#233;gler cela afin que vous puissiez &#234;tre satisfait &#224; temps.</p><p style=\"Margin-top: 20px;Margin-bottom: 0;\">Merci de votre compr&#233;hension.</p>\n" +
"      </div>\n" +
"    </div>\n" +
"        \n" +
"          </div>\n" +
...
"                  <div>Global Expertise<br />\n" +
"Votre satisfaction, notre priorit&#233;</div>\n" +
"                </div>\n" +
